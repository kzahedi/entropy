...
FeatureMatrixsp::FeatureMatrixsp(DContainer &eX, DContainer &eY, DContainer &aX, DContainer &aY, double valuelambda)
{
  _valX        = &eX;
  _valY        = &eY;
  _X           = &aX;
...
FeatureMatrixsp::FeatureMatrixsp()
{
...
double FeatureMatrixsp:: getFeatureArraylambda(int i, int j,int ilambdaX, int ilambdaY)
{
...
double FeatureMatrixsp:: getFeatureArrayvalue(int i, int j,double ValX, double ValY)
{
  assert(i<_sizeColValX && j<_sizeColValY);
...
void FeatureMatrixsp::setFeatureArraylambda(int i, int j,int ilambdaX, int ilambdaY,double valuelambda)
{
  assert(i<_sizeColValX && j<_sizeColValY);
  _FA[i][j].setlambda(ilambdaX,ilambdaY,valuelambda);
}

int FeatureMatrixsp:: getFeatureArraydelta(int i, int j,int idelta, int jdelta, double ValX, double ValY)
{
  assert(i<_sizeColValX && j<_sizeColValY);
...
int FeatureMatrixsp::getMatrixIndexX(int i, int j,int k)
{
  assert(i<_sizeRowValX && j< _sizeRowValY );
  return (*_Feati)(i,j,k);
}

int FeatureMatrixsp:: getMatrixIndexY(int i, int j, int k)
{
  assert(i<_sizeRowValX && j< _sizeY );
  return (*_Featj)(i,j,k);
}

int FeatureMatrixsp:: getMatrixIndexdX(int i,int j,int k)
{
  assert(i<_sizeRowValX && j< _sizeY );
  return (*_Delti)(i,j,k);
}

int FeatureMatrixsp:: getMatrixIndexdY(int i,int j,int k)
{
  assert(i<_sizeRowValX && j< _sizeY );
  return (*_Deltj)(i,j,k);
}

Feature** FeatureMatrixsp:: FeatureArray( double valuelambda)
{
  Feature **FA;
...
void FeatureMatrixsp::__getMatrix(double valuelambda)
{
