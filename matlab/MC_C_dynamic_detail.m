function [ r ] = MC_C_dynamic_detail( w2, w1, s1, a1 )
...
for t = 1:l
    ...
    cifw2w1 = log2(pw2w1(w2w1index,3))  - log2(pw2(w2index,2) * pw1(w1index,2));
    cifw2a1 = log2(pw2doa(w2a1index,3)) - log2(hatpw);
    
    nv = [cifw2w1 - cifw2a1, cifw2w1, cifw2a1];
    found = 0;
    for x = 1:size(v,1)
    ...
    if found == 0
        v(t, :)= [double(w2t), double(w1t), double(a1t), cifw2w1 - cifw2a1, cifw2w1, cifw2a1];
    end
