...
for w2index = 1:w2max
    for a1index = 1:a1max
        if hatpw2(w2index) > 0.0 && pw2_c_do_a1(w2index, a1index) > 0.0
            cif_w2_to_a1 = cif_w2_to_a1 + pw2_c_do_a1(w2index, a1index) * pa1(a1index) * log2( pw2_c_do_a1(w2index, a1index) / (hatpw2(w2index,1)));
        end
    end
end

r = cif_w2_to_w1 - cif_w2_to_a1;
