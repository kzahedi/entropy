...
void modelTest::testUnique()
{
  ...
  Model* mlmodel = new Model();
  mlmodel->setData(mlXY, mlZ);
  mlmodel->setRelations(a,b,r);
...
void modelTest::testUnique2()
{
  ...
  vector<Relation> r;
  r.push_back(Relation(0,0));
  r.push_back(Relation(1,0));
  r.push_back(Relation(2,0));
